...
def build_user_prompt(
    ...
    return (
        ...
        "and available structural evidence from PDB or AlphaFold entries. "
        ...
        "When describing a specific domain or feature, you MUST insert the placeholder of its "
        "corresponding feature_slice entry inline at that point in the text. "
        "Use full-structure placeholders only when discussing the overall protein architecture. "
